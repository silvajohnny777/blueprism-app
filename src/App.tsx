...
import {
  ...
  setScheduleError,
} from "./GlobalRedux/schedulesSlice";
import {
  setScheduleLogs,
  setIsLoadingLogsSchedules,
  setScheduleLogsError,
} from "./GlobalRedux/scheduleLogsSlice";
...
const App: React.FC = () => {
  ...
  const getSchedules = async () => {
    ...
    try {
      const response = await axios.get<ScheduleTypes[]>(
  ...
  const getScheduleLogs = async () => {
    ...
    try {
      const response = await axios.get<ScheduleLogTypes[]>(
